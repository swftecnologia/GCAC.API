...
{
    /// <summary>
    /// Interface de serviço para a entidade Grupo
    /// </summary>
    public interface IGrupoServico
    {
        ...
        /// <returns>Registro do grupo do participante solicitada</returns>
        Task<Grupo> SelecionarPorId(long id);

        /// <summary>
        /// Cria um novo grupo do participante
        /// </summary>
        /// <param name="item">Novo grupo do participante a ser criada</param>
        ...
        /// </summary>
        /// <param name="item">Grupo do participante a ser atualizada</param>
        /// <returns>Quantidade de registros afetados pela operação solicitada</returns>
        ...
        /// </summary>
        /// <param name="item">Grupo do participante a ser excluída</param>
        /// <returns>Quantidade de registros afetados pela operação solicitada</returns>
        ...
        /// <summary>
        /// Verifica se o grupo do participante existe por descrição para um identificador diferente do grupo do participante a ser alterada
        /// </summary>
        /// <param name="id">Identificador único do grupo do participante</param>
        /// <param name="descricao">Descrição do grupo do participante</param>
        /// <returns>Valor indicando se o grupo do participante existe ou não</returns>
